...
var addMsg = function addMsg(msg, owner) {
...
var socketFunction = {
	onconnect: function onconnect(mine) {
		this.socket.emit("userConnected", mine.id);
	},
	onsendmsg: function onsendmsg(mine, msg) {
	...
	onreceivemsg: {
		private: function _private(data) {
			var li = void 0;
			switch (data.sender) {
				case mine.id:
